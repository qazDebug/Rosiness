/****************************************************
	文件：AssemblyUtility.cs
	作者：世界和平
	日期：2020/11/28 11:55:52
	功能：Nothing
*****************************************************/
using System;
...
namespace Rosiness.Utility
{
    ...
    {
        public const string RosinessAssemblyName = "Rosiness";
        public const string RosinessAssemblyEditorName = "Rosiness.Editor";
        ...
        private static List<Type> GetTypes(string assemblyName)
        {
            ...
            // 注意：如果没有找到程序集返回空列表
            Debug.LogWarning($"Not found assembly : {assemblyName}");
		...
		/// </summary>
        public static List<Type> GetAssignableTypes(string assemblyName, Type parentType)
        {
