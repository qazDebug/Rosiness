/****************************************************
	文件：AssetImporterWindow.cs
	作者：世界和平
	日期：2021/2/25 15:34:9
	功能：Nothing
*****************************************************/
...
namespace Rosiness.Editor
{
    public class AssetImporterWindow : EditorWindow
    {
        ...
        [MenuItem("Rosiness/Asset Importer", false, 104)]
        static void ShowWindow()
        {
            if (_thisInstance == null)
            {
                _thisInstance = GetWindow(typeof(AssetImporterWindow), false, "资源导入工具", true) as AssetImporterWindow;
