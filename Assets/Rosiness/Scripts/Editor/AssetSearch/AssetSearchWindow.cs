/****************************************************
	文件：AssetSearchWindow.cs
	作者：世界和平
	日期：2021/2/25 15:51:48
	功能：Nothing
*****************************************************/
using System;
...
namespace Rosiness.Editor
{
    public class AssetSearchWindow : EditorWindow
    {
        ...
        [MenuItem("Rosiness/Asset Search", false, 103)]
        ...
        private void FindReferenceInProject(string searchAssetPath, string searchFolder, EAssetSearchType serachType)
        {
            ...
            foreach (string guid in allGuids)
            {
                ...
                curCount++;
                ShowProgress(curCount / (float)allGuids.Length, allGuids.Length, curCount);
            }
        ...
        private void FindInternal(GameObject[] prefabs)
        {
            ...
            for (int i = 0; i < prefabs.Length; i++)
            {
                ...
                if (cloneObject == null)
                {
                    ...
                    if (cloneObject == null)
                        cloneObject = UnityEngine.Object.Instantiate(prefab);
        ...
        {
            GameObject[] findObjects = UnityEngine.Object.FindObjectsOfType<GameObject>();
